...
export const EXPERIENCE: Role[] = [
  ...
  {
    period: { ar: 'يناير 2025 إلى مايو 2025', en: 'January 2025 — May 2025' },
  ...
  {
    period: { ar: 'مايو 2022 إلى يونيو 2022', en: 'May 2022 — June 2022' },
  ...
  {
    period: { ar: 'يوليو 2013 إلى سبتمبر 2013', en: 'July 2013 — September 2013' },
...
export const CERTS: { title: Bi; org: Bi; date: Bi }[] = [
  ...
  { title: { ar: 'معسكر تدريبي في تحليل البيانات: Python وExcel وPower BI', en: 'Data analysis bootcamp: Python, Excel and Power BI' }, org: { ar: 'Assal Education', en: 'Assal Education' }, date: { ar: 'مايو إلى سبتمبر 2024', en: 'May — September 2024' } },
