...
export const ui = {
  ar: {
    ...
    // --- home ---
    'home.title': 'باحث اقتصادي في تمويل التنمية وتمويل المنشآت الصغيرة والمتوسطة',
    'home.desc':
    ...
    'reports.intro':
      'تقارير قصيرة تجمع بيانات منشورة متفرّقة في سلسلة واحدة متّصلة، وتفصل صراحةً بين ما ينشره المصدر وما يحسبه الباحث.',
  ...
  en: {
    ...
    'reports.intro':
      'Short reports that assemble scattered published data into one continuous series, and state plainly which figures the source published and which the author derived.',
