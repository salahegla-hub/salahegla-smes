...
export const ui = {
  ar: {
    ...
    'nav.reports': 'التقارير',   // شريط التنقّل فقط؛ الاسم الكامل في reports.h1
    ...
    'reports.title': 'التقارير الاقتصادية',
    'reports.desc': 'تقارير اقتصادية دورية عن تمويل المنشآت الصغيرة والمتوسطة وريادة الأعمال في قطر والخليج، مبنية على بيانات منشورة.',
    'reports.h1': 'التقارير الاقتصادية',
    'reports.intro':
      'سلاسل «مرصد» — تقارير قصيرة تجمع بيانات منشورة متفرّقة في سلسلة واحدة متّصلة، وتفصل صراحةً بين ما ينشره المصدر وما يحسبه الباحث.',
    'reports.backToAll': 'كل التقارير الاقتصادية',
    'reports.empty': 'لا توجد تقارير مطابقة',
    'reports.series': 'السلسلة',
    'reports.issue': 'الإصدار',
  ...
  en: {
    ...
    'nav.reports': 'Reports',   // nav bar only; the full name lives in reports.h1
    ...
    'reports.title': 'Economic Reports',
    'reports.desc': 'Periodic data briefs on SME finance and entrepreneurship in Qatar and the Gulf, built entirely from published sources.',
    'reports.h1': 'Economic Reports',
    'reports.intro':
      'The "Observatory" series — short reports that assemble scattered published data into one continuous series, and state plainly which figures the source published and which the author derived.',
    'reports.backToAll': 'All economic reports',
    'reports.empty': 'No matching reports',
    'reports.series': 'Series',
    'reports.issue': 'Issue',
